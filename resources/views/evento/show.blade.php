        ...
        <div class="col-md-12 ">
            <div class="row">
                <div id="image-container" class="col-md-6 col-lg-4 mb-2">
                    <img src="{{ url('img/evento/') }}/{{ $evento->image }}" width="800" height="800" class="img-fluid mb-12"
                        alt="{{ $evento->title }}">
                </div>
                <div id="info-container" class="col-md-6 col-lg-8">
                    <h1>{{ $evento->title }}</h1>
                    <p class="evento-city"><i class="bi bi-geo-alt-fill"></i> {{ $evento->city }}</p>
                    <p class="evento-participantes"><i class="bi bi-people-fill"></i> {{ count($evento->users) }} Participantes
                    </p>
